...
function Map(props) {
    var plugins = props.plugins, style = props.style, mapOptions = props.mapOptions, fullScreen = props.fullScreen;
    ...
    return (React.createElement("div", { className: isFullScreen ? 'fullMapContainer mapContainer' : 'mapContainer', style: isFullScreen ? fullMapStyle : __assign({}, style) },
        React.createElement(exports.MapContext.Provider, { value: map },
            ...
            props.children),
        fullScreen && React.createElement("div", { className: isFullScreen ? 'fullBtn fullfix' : 'fullBtn', onClick: function () { return handleFullScreen(); } }),
