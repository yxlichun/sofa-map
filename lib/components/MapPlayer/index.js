...
function MapPlayer(props) {
    ...
    var onPlay = function (current) {
        ...
        var nearestTime = timeArray.find(function (item, index) {
            return current < parseInt(timeArray[index + 1], 10);
    ...
    MapPlayer.map = Map_1.default.map;
    return (React.createElement(React.Fragment, null,
        React.createElement(Map_1.default, __assign({ style: { width: 600, height: 400 }, name: name }, mapProps), props.children({ frameData: frameData, preTime: preTime })),
